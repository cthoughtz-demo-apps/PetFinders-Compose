...
interface GetOrganizationRepository {
    suspend fun getOrganization(id: String, authToken: String) : PetFinderResult<GetOrganizationResponse>
}

class GetOrganizationRepositoryImpl @Inject constructor(private val apiService: ApiService): GetOrganizationRepository {
    override suspend fun getOrganization(id: String, authToken: String): PetFinderResult<GetOrganizationResponse> {
